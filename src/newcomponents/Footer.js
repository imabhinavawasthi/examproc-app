        ...
        <>
            <footer className="p-4 md:p-8 lg:p-10 dark:bg-gray-800">
                <div className="mx-auto max-w-screen-xl text-center">
                    ...
                    <p className="my-6 text-gray-500 dark:text-gray-400">Simplifying Exam Supervision: Effortless Proctoring Solutions Tailored for Today's Needs.</p>
                    <ul className="flex flex-wrap justify-center items-center mb-6 text-gray-900 dark:text-white">
                        <li>
                            <a href={docLink} className="mr-4 hover:underline md:mr-6 ">Project Documentation</a>
                        </li>
                    </ul>
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023-2024 <a href="#" className="hover:underline">ExamProc</a>. All Rights Reserved.</span>
                </div>
            </footer>
        </>
    );
